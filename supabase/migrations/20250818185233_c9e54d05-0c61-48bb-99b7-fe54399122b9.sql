-- Remove the old trigger that might be causing conflicts
DROP TRIGGER IF EXISTS auto_generate_organization_slug ON public.organizations;

-- Optimize the ensure_unique_slug function to prevent infinite loops
