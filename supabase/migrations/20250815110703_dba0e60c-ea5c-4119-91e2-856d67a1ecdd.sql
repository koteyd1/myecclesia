...
-- 5. Create function to mask sensitive payment data for non-admin users
...
-- 6. Create function to validate anonymous donation data before insertion
...
-- 7. Create trigger for anonymous donation validation
...
-- 8. Enhanced audit trigger for donation updates and deletes
...
-- 9. Create triggers for audit logging on updates and deletes
...
CREATE TRIGGER audit_donation_changes_trigger
  ...
  FOR EACH ROW
  EXECUTE FUNCTION public.audit_sensitive_donation_changes();