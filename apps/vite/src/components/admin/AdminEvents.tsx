  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingEvent) {
        ...
        // For inserts, set created_by and slug will be auto-generated by database trigger
        result = await supabase
          .from("events")
      ...
      if (createdEvent && !editingEvent) {
        try {
          const { error: notifyError } = await supabase.functions.invoke("send-event-notification", {
